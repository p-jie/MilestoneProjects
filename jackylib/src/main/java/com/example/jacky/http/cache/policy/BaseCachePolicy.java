...
package com.example.jacky.http.cache.policy;
...
import com.example.jacky.http.db.CacheManager;
import com.example.jacky.http.exception.HttpException;
import com.example.jacky.http.model.Response;
import com.example.jacky.http.request.base.Request;
import com.example.jacky.http.utils.HeaderParser;
...
public abstract class BaseCachePolicy<T> implements CachePolicy<T> {
    ...
    protected void runOnUiThread(Runnable run) {
        JackHttp.getInstance().getDelivery().post(run);
    }
