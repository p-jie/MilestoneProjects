...
package com.example.jacky.http.db;
...
import com.example.jacky.http.cookie.SerializableCookie;
...
class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_CACHE_NAME = "jackyhttp.db";
    ...
    DBHelper() {
        this(JackHttp.getInstance().getContext());
    }
