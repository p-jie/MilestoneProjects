...
package com.example.jacky.http.request.base;

import android.text.TextUtils;


import com.example.jacky.http.JackHttp;
import com.example.jacky.http.adapter.AdapterParam;
import com.example.jacky.http.adapter.CacheCall;
import com.example.jacky.http.adapter.Call;
import com.example.jacky.http.adapter.CallAdapter;
import com.example.jacky.http.cache.CacheEntity;
import com.example.jacky.http.cache.CacheMode;
import com.example.jacky.http.cache.policy.CachePolicy;
import com.example.jacky.http.callback.Callback;
import com.example.jacky.http.convert.Converter;
...
public abstract class Request<T, R extends Request> implements Serializable {
    ...
    public Request(String url) {
        this.url = url;
        baseUrl = url;
        JackHttp go = JackHttp.getInstance();
    ...
    public okhttp3.Call getRawCall() {
        ...
        if (client == null) client = JackHttp.getInstance().getOkHttpClient();
