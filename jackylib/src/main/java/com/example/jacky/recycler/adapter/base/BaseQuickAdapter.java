 ...
 */
package com.example.jacky.recycler.adapter.base;
...
import com.example.jacky.recycler.adapter.base.animation.AlphaInAnimation;
import com.example.jacky.recycler.adapter.base.animation.BaseAnimation;
import com.example.jacky.recycler.adapter.base.animation.ScaleInAnimation;
import com.example.jacky.recycler.adapter.base.animation.SlideInBottomAnimation;
import com.example.jacky.recycler.adapter.base.animation.SlideInLeftAnimation;
import com.example.jacky.recycler.adapter.base.animation.SlideInRightAnimation;
import com.example.jacky.recycler.adapter.base.entity.IExpandable;
import com.example.jacky.recycler.adapter.util.MultiTypeDelegate;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    private void checkNotNull() {
        if (getRecyclerView() == null) {
            throw new RuntimeException("please bind recyclerView orange!");
        }
    }
     ...
     *
     * @param firstOnly true just show anim when orange loading false show anim when load the data every time
     */
