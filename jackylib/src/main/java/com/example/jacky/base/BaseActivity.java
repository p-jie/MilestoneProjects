...
public class BaseActivity extends AppCompatActivity implements Presenter, GestureDetector.OnGestureListener {
    ...
    public void setContentView(int layoutResID) {
        ...
        tintManager.setStatusBarTintResource(R.color.transparency);//状态背景色，可传drawable资源
        // 状态栏沉浸，4.4+生效 >>>>>>>>>>>>>>>>>
    ...
    public void setContentView(int layoutResID, OnBottomDragListener listener) {
        ...
        baseBinding = DataBindingUtil.setContentView(this, layoutResID);
    ...
    protected void onDestroy() {
        ...
        context = null;
        JackHttp.getInstance().cancelAll();
